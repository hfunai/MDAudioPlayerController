...
DESC
s.homepage = "https://github.com/hfunai/MDAudioPlayerController"
s.license = { :type => 'Modified BSD', :file => 'README.markdown' }
s.requires_arc = true
s.author = { "Matt Donnelly" => "" }
s.platform = :ios
s.source = { :git => "https://github.com/hfunai/MDAudioPlayerController.git", :commit => "71fcb55c97a3a8b5a80f47138b7727920c3c1e87" }
